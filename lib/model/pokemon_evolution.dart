...
PokemonEvolution pokemonEvolutionFromJson(String str) => PokemonEvolution.fromJson(json.decode(str));

String pokemonEvolutionToJson(PokemonEvolution data) => json.encode(data.toJson());
...
class PokemonEvolution {
    ...
    factory PokemonEvolution.fromJson(Map<String, dynamic> json) => PokemonEvolution(
