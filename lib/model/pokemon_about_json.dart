...
//
//     final pokemonAboutJson = pokemonAboutJsonFromJson(jsonString);

import 'dart:convert';

PokemonAboutJson? pokemonAboutJsonFromJson(String str) =>
    PokemonAboutJson.fromJson(json.decode(str));

String pokemonAboutJsonToJson(PokemonAboutJson? data) =>
    json.encode(data!.toJson());

class PokemonAboutJson {
  PokemonAboutJson({
    this.baseHappiness,
    this.captureRate,
    this.color,
  ...
  factory PokemonAboutJson.fromJson(Map<String, dynamic> json) =>
      PokemonAboutJson(
