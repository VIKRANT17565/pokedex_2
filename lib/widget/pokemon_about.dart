  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<PokemonAboutProvider>(
      builder: (context, snapShot, child) {
        // if (!snapShot.pokemonAboutJson.containsKey(id - 1) ||
        //     !snapShot.pokemonAboutJson.containsKey(id) ||
        //     !snapShot.pokemonAboutJson.containsKey(id + 1)) {
        //   snapShot.getDataAbout(id - 1);
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                    ...
                    children: aboutPokemonText1 != aboutPokemonText2
                        ? [
                            Text(
                              aboutPokemonText1,
                              style:
                                  const TextStyle(fontSize: 15, wordSpacing: 7),
                            ),
                            const SizedBox(
                              height: 15,
                            ),
                  ...
                  // Height and weight of i'th pokemon
